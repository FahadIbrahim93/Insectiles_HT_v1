...
export default function GameHud({ score, highScore, isFeverMode, feverProgress }: GameHudProps) {
  return (
    <div data-testid="game-hud" className="absolute top-4 left-0 right-0 z-10 flex flex-col px-6 pointer-events-none">
      <div className="flex justify-between items-start">
        ...
        <div data-testid="high-score" className="text-white/50 font-mono text-xl drop-shadow-md">Best: {highScore}</div>
      </div>
      {!isFeverMode && (
